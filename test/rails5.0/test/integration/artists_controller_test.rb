...
class ArtistsControllerTest < Trailblazer::Test::Integration
  ...
  it "expose" do
    ...
    page.body.must_match %{<p>#<Song id: nil, title: nil, user_name: \"user_name\">,Reform::Form,nil</p>}
  end

  it "expose with additional args" do
    visit "/artists/with_expose_and_args"
    page.body.must_match %{<p>#<Song id: nil, title: nil, user_name: \"user_name\">,Reform::Form,#<Song id: nil, title: nil, user_name: \"user_name\"></p>}
  end
end
