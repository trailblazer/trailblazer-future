module Trailblazer::V2_1::Developer
  module Wtf
    ...
    module Renderer
      ...
      SIGNALS_MAP = {
        :'Trailblazer::V2_1::Activity::Right' => :pass,
        :'Trailblazer::V2_1::Activity::FastTrack::PassFast' => :pass,

        :'Trailblazer::V2_1::Activity::Left' => :fail,
        :'Trailblazer::V2_1::Activity::FastTrack::FailFast' => :fail,
      }
