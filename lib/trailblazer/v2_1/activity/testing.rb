...
module Trailblazer::V2_1
  module Activity::Testing
    ...
    module Assertions
        Activity  = Trailblazer::V2_1::Activity
        Inter     = Trailblazer::V2_1::Activity::Schema::Intermediate
        Schema    = Trailblazer::V2_1::Activity::Schema
        TaskWrap  = Trailblazer::V2_1::Activity::TaskWrap
        ...
        def Cct(activity)
          Trailblazer::V2_1::Developer::Render::Circuit.(activity)
        end
        ...
        def assert_process_for(process, *args)
          ...
          inspects = semantics.collect { |semantic| %{#<struct Trailblazer::V2_1::Activity::Output signal=#<Trailblazer::V2_1::Activity::End semantic=#{semantic.inspect}>, semantic=#{semantic.inspect}>} }
        ...
        def assert_circuit(schema, circuit)
          cct = Cct(schema)
          cct = cct.gsub("#<Trailblazer::V2_1::Activity::TaskBuilder::Task user_proc=", "<*")
