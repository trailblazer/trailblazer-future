  ...
  class Activity
    ...
    class FastTrack
      ...
      module DSL
        ...
        def normalizer
          step_options(Trailblazer::V2_1::Activity::Railway::DSL.normalizer)
        end

        def normalizer_for_fail
          sequence = step_options(Trailblazer::V2_1::Activity::Railway::DSL.normalizer_for_fail)
        ...
        def normalizer_for_pass
          sequence = step_options(Trailblazer::V2_1::Activity::Railway::DSL.normalizer_for_pass)
