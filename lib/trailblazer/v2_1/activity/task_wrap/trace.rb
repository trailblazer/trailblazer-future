  ...
  module TaskWrap
    ...
    module Trace
      ...
      def self.capture_args((wrap_config, original_args), **circuit_options)
        ...
        original_flow_options[:stack] << Trailblazer::V2_1::Activity::Trace::Entity.new( wrap_config[:task], :args, nil, {}, original_circuit_options[:introspect] )

        [ Trailblazer::V2_1::Activity::Right, [wrap_config, original_args], **circuit_options ]
      end
      ...
      def self.capture_return((wrap_config, original_args), **circuit_options)
        ...
        original_flow_options[:stack] << Trailblazer::V2_1::Activity::Trace::Entity.new(  wrap_config[:task], :return, wrap_config[:return_signal], {} )
