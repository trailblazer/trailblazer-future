          ...
          module ClassMethods
            ...
            def Path(track_color: "track_#{rand}", connect_to: nil, before: false, **options, &block)
              ...
              adds = seq.collect do |row|
                ...
                insert_target = before if before && connect_to.instance_of?(Trailblazer::V2_1::Activity::DSL::Linear::Helper::Track) # FIXME: this is a bit hacky, of course!
            ...
            private def connect_for_sequence(sequence, connect_to:)
              ...
              searches = [Search.ById(output, connect_to.value)] if connect_to.instance_of?(Trailblazer::V2_1::Activity::DSL::Linear::Helper::Id)
              searches = [Search.Forward(output, connect_to.color)] if connect_to.instance_of?(Trailblazer::V2_1::Activity::DSL::Linear::Helper::Track) # FIXME: use existing mapping logic!
